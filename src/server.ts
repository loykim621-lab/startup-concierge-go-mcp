...
5-1) 서류 원스톱: 공고 서식을 붙여넣기(locate_form_source 안내 후 사용자가 붙여넣음) → analyze_form → required_inputs 교차질문 → compose_application → plan_review 재검증 → export_document(다운로드+전문)까지 이어서 안내한다.
